...
import { space, color, fontSize, width, fontWeight, lineHeight } from '@soroush.tech/styled-system'
...
const Heading = (props) => <Text as="h2" fontSize={5} lineHeight="1.25" m={0} {...props} />
  ...
  render() {
    return (
      <ThemeProvider theme={theme}>
        <Root>
          <Style />
          <Box px={{ _: 3, medium: 4 }} py={{ _: 5, medium: 6 }} color="white" bg="blue">
            <Heading fontSize={{ _: 4, small: 5, medium: 6 }}>Styled System</Heading>
